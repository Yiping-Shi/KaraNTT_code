...
if __name__ == "__main__":
    ...
    # File paths
    RESULTS_DIR = "Results"
    D0_FILE = os.path.join(RESULTS_DIR, "D0.txt")   # Schoolbook polynomial multiplication
    C1_FILE = os.path.join(RESULTS_DIR, "C1.txt")   # NWC Schoolbook polynomial multiplication
    N_FILE  = os.path.join(RESULTS_DIR, "N.txt")    # NWC NTT polynomial multiplication
